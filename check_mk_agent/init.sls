...
check_mk-deb-present:
  file.managed:
    - source: salt://check_mk_agent/files/deb/check-mk-agent_2019.02.18-1_all.deb
    - name: /var/cache/apt/archives/check-mk-agent_2019.02.18-1_all.deb

   

install-cmk-agent:
  cmd.run:
    - name: dpkg -i /var/cache/apt/archives/check-mk-agent_2019.02.18-1_all.deb
